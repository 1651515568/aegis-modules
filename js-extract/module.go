...
func (m *Module) Init(k core.Kernel) error {
	...
	m.dataDir = filepath.Join("data", "js-extract")
	m.log.Info("js-extract module initialized")
	return nil
}
...
func (m *Module) OnEnable(_ context.Context) error {
	...
	m.log.Info("js-extract module enabled")
	return nil
}
...
func (m *Module) OnDisable(_ context.Context) error {
	...
	m.mu.Unlock()
	m.log.Info("js-extract module disabled")
	return nil
}
