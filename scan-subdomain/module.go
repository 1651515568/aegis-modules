...
// Module implements core.Module + core.Migrator for the 子域名枚举 capability.
type Module struct {
...
func (m *Module) Init(k core.Kernel) error {
	...
	m.sc = newScanner(m.log)
	m.log.Info("subdomain module initialized")
	return nil
}
...
func (m *Module) OnEnable(_ context.Context) error {
	...
	m.log.Info("subdomain module enabled")
	return nil
}
...
func (m *Module) OnDisable(_ context.Context) error {
	...
	m.mu.Unlock()
	m.log.Info("subdomain module disabled")
	return nil
}
